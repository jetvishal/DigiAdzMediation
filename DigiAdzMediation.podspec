#
#  Be sure to run `pod spec lint DigiAdzMediation.podspec' to ensure this is a
...
Pod::Spec.new do |s|
 ...
 s.swift_version = "4.2"
  ...
  s.source       = { :git => "https://github.com/jetvishal/DigiAdzMediation.git", :tag => "#{s.version}" }
  ...
  s.source_files  = 'Classes/*.{h,m,swift}',"DigiAdz","AppTracker","HyprMX","IronSourceSDK"
